    ...
    $.fn.bart = function( method ) {
        ...
        var opts = {
            ...
            onend: function() {
                ...
                var newWindow = window.open("", "Resultados", "width=600,height=400");
...
.catch(err => console.error("❌ Error al enviar:", err));
        ...
        var iterationResults = []; // Arreglo para almacenar los resultados de cada iteración
        ...
        balloon.prototype.save = function() {
            ...
            // Agregar los resultados de esta iteración al arreglo
